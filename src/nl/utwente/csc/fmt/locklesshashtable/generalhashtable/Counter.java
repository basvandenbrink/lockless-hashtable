...
package nl.utwente.csc.fmt.locklesshashtable.generalhashtable;

/**
 * A simple high-performance counter.  Merely renames the extended {@link
 * org.Hashtable.hashtable.ConcurrentAutoTable} class to be more obvious.
 * {@link org.Hashtable.hashtable.ConcurrentAutoTable} already has a decent
 * counting API.
 *
 * @since 1.5
 * @author Cliff Click
